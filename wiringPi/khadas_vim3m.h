...
/*------------------------------------------------------------------------------------------*/
#ifndef __KHADAS_VIM3M_H__
#define __KHADAS_VIM3M_H__
...
#define VIM3_GPIO_PIN_BASE				427
#define VIM3_GPIOAO_PIN_BASE			412

#define VIM3_GPIOA_PIN_START			(VIM3_GPIO_PIN_BASE + 49) 
#define VIM3_GPIOA_PIN_END				(VIM3_GPIO_PIN_BASE + 64)
#define VIM3_GPIOH_PIN_START			(VIM3_GPIO_PIN_BASE + 16)
#define VIM3_GPIOH_PIN_END				(VIM3_GPIO_PIN_BASE + 24)
#define VIM3_GPIOZ_PIN_START			(VIM3_GPIO_PIN_BASE + 0)
#define VIM3_GPIOZ_PIN_END				(VIM3_GPIO_PIN_BASE + 15)
#define VIM3_GPIOAO_PIN_START			(VIM3_GPIOAO_PIN_BASE + 0)
#define VIM3_GPIOAO_PIN_END				(VIM3_GPIOAO_PIN_BASE + 12)
...
extern void init_khadas_vim3m(struct libkhadas *libwiring);
