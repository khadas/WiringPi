...
#define VIM3_GPIOA_PIN_START			(VIM3_GPIO_PIN_BASE + 50) 	 	//300
#define VIM3_GPIOA_PIN_END				(VIM3_GPIO_PIN_BASE + 65)
#define VIM3_GPIOH_PIN_START			(VIM3_GPIO_PIN_BASE + 17)	//300+20=320
#define VIM3_GPIOH_PIN_END				(VIM3_GPIO_PIN_BASE + 25)
#define VIM3_GPIOZ_PIN_START			(VIM3_GPIO_PIN_BASE + 1)	//300+30=330
#define VIM3_GPIOZ_PIN_END				(VIM3_GPIO_PIN_BASE + 16)
#define VIM3_GPIOAO_PIN_START			(VIM3_GPIO_PIN_BASE + 86)	//300+50=350
